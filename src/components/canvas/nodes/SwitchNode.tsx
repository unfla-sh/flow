...
import { SWITCH_DEFAULT_HANDLE, type WorkflowNode } from '@/types/workflow'
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 border-b px-3 py-2">
        <span
          className="flex size-6 shrink-0 items-center justify-center rounded-md bg-sky-100 text-sky-700"
