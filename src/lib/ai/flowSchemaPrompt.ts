...
Edge: { "id": string (unique), "source": nodeId, "target": nodeId, "label"?: string, "sourceHandle"?: string, "targetHandle"?: string, "data"?: { "kind"?: "flow"|"reporting"|"relationship"|"network"|"data"|"dependency", "condition"?: string, "protocol"?: string, "sourceCardinality"?: "one"|"zero-one"|"many"|"zero-many", "targetCardinality"?: "one"|"zero-one"|"many"|"zero-many", "route"?: {"kind":"auto"|"manual","points"?: [{"x":number,"y":number}]}, "labelPosition"?: {"along"?: 0..1 fraction of the path, "dx"?: number, "dy"?: number}, "style"?: { "stroke"?: string, "arrow"?: boolean, "arrowStart"?: boolean, "bidirectional"?: boolean, "lineWidth"?: number, "arrowSize"?: number, "lineStyle"?: "solid"|"dashed"|"dotted", "pathType"?: "bezier"|"step" } } }
